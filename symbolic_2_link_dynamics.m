...
%--- DESCRITPION----
% This script creates symbolic dynamics function using Forward Euler
% integration method. The 2 degrees of freedom arm model is simple enough for its dynamics (Mass matrix M and Coriolis matrix C) to be
% hand derived on paper and transfered to matlab. 
%-------------------
